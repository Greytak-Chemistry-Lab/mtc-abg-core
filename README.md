...
Folders will be named (within the repo) as:
"variation-version"
or just 
"variation"  
for the current version of each variation.

Example layout: (for our "matlab toolbox for chemists" core repo)

mtc-abg-core/og ... as it was set up
mtc-abg-core/fancy ... a variation with some improvements after bringing to Github
